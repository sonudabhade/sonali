 ...
 *
 */
public class AdapterProductListApproved extends RecyclerView.Adapter<AdapterProductListApproved.MyViewHolderProductListPending> {



    private Context mContext;
    private ArrayList<ProductListApprovedModel> mProductListApprovedModelArrayList;
    private ProductListApprovedFragment mProductListApprovedFragment;

    public AdapterProductListApproved(Context mContext, ArrayList<ProductListApprovedModel> mProductListApprovedModelArrayList, ProductListApprovedFragment productListApprovedFragment) {
        this.mContext = mContext;
        this.mProductListApprovedModelArrayList = mProductListApprovedModelArrayList;
        mProductListApprovedFragment=productListApprovedFragment;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolderProductListPending myViewHolderProductListPending, int i) {
        ...
        final ProductListApprovedModel productListApprovedModel = mProductListApprovedModelArrayList.get(i);

        myViewHolderProductListPending.tvProductName.setText(productListApprovedModel.getProduct_name());
        myViewHolderProductListPending.tvCatName.setText(productListApprovedModel.getCat_name() + "/" + productListApprovedModel.getSubcat_name());

        try {
            Picasso.get().load(productListApprovedModel.getImage_name()).placeholder(R.drawable.default_document).into(myViewHolderProductListPending.ivProductImage);
        } catch (Exception e) {

        }


        if (productListApprovedModel.getCost().equalsIgnoreCase("")){
            ...
            myViewHolderProductListPending.tvCost.setText(productListApprovedModel.getCurrency()+" "+productListApprovedModel.getCost());
        ...
        myViewHolderProductListPending.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("PK_id",productListApprovedModel.getPk_id());
        ...
        myViewHolderProductListPending.LinearLayoutEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bundle bundle=new Bundle();
                bundle.putString("PK_id",productListApprovedModel.getPk_id());
                bundle.putString("from_Pending","from_Approved");
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (InternetConnection.isInternetAvailable(mContext)) {
                                    ...
                                    mProductListApprovedFragment.DeleteProduct(productListApprovedModel.getPk_id());
    ...
    public int getItemCount() {
        return mProductListApprovedModelArrayList.size();
    }
