...
public class BuyerEnquiryListFragment extends Fragment {
    ...
    public BuyerEnquiryListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Constants.mMainActivity.setToolBarPostEnquiry();
    ...
    private void getEnquiryList() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_ENQUIRY_LIST, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Log.e("response", "getEnquiryList Buyer-->>" + response);
...
//                            enquiryListModel.setWaiting_for_response(jsonObjectMyenquiry.getString("waiting_for_response"));
