...
public class BuyerPersonalDetailsFragment extends Fragment {
    ...
    public BuyerPersonalDetailsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_buyer_personal_details, container, false);
...
// *
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("usertype", mSessionManager.getStringData(Constants.KEY_USER_TYPE));
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonObject.getString("error_code").equals("1")) {
                        ...
                        try {
                            mSessionManager.putStringData(Constants.USER_LANG, jsonObject.getString("language"));
                        ...
                        mSessionManager.putStringData(Constants.KEY_BUYER_PROFILE, jsonObject.getString("profile_image") + jsonObject.getString("profile"));
