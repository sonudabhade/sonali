 ...
 *
 */
public class AdapterBuyerFavoritesList extends RecyclerView.Adapter<AdapterBuyerFavoritesList.MyViewHolderProductListPending> {



    private Context mContext;
    private ArrayList<FavoritesListModel> mFavoritesListModelArrayList;
    private BuyerFavouritesFragment mFavouritesFragment;


    public AdapterBuyerFavoritesList(Context mContext, ArrayList<FavoritesListModel> FavoritesListModelArrayList, BuyerFavouritesFragment favouritesFragment) {
