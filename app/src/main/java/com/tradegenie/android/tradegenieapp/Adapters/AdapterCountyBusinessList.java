...
public class AdapterCountyBusinessList extends ArrayAdapter<CountryListBusinessModel> {
    ...
    public AdapterCountyBusinessList(@NonNull Context context, int resource, int textViewResourceId, @NonNull ArrayList<CountryListBusinessModel> objects) {
