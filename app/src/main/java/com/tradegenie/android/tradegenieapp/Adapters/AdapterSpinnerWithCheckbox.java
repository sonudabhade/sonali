...
public class AdapterSpinnerWithCheckbox extends ArrayAdapter<StateVO> {

    private Context mContext;
    public ArrayList<StateVO> listState;
    private AdapterSpinnerWithCheckbox mAdapterSpinnerWithCheckbox;
    private boolean isFromView = false;
    private AddNewProduct mAddNewProduct;


    public AdapterSpinnerWithCheckbox(Context context, int resource, List<StateVO> objects, AddNewProduct addNewProduct) {
    ...
    public View getCustomView(final int position, View convertView,
        ...
        holder.mCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                mAddNewProduct.getModeofPayCount();
