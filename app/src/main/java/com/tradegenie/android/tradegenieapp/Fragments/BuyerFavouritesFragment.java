...
import com.tradegenie.android.tradegenieapp.Adapters.AdapterBuyerFavoritesList;
...
public class BuyerFavouritesFragment extends Fragment {
    ...
    private AdapterBuyerFavoritesList mAdapterFavoritesList;
    ...
    public BuyerFavouritesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //  }else {
            ...
            mAdapterFavoritesList = new AdapterBuyerFavoritesList(getActivity(), mFavoritesListModelArrayList, BuyerFavouritesFragment.this);
