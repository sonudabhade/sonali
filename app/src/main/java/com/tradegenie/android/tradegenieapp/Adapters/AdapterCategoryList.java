...
public class AdapterCategoryList extends ArrayAdapter<CategoryModel> {
    ...
    public AdapterCategoryList(@NonNull Context context, int resource, int textViewResourceId, @NonNull ArrayList<CategoryModel> objects) {
