...
public class EnquiryDetailsPostRequirementFragment extends Fragment {
   ...
   /* @BindView(R.id.linearLayoutTaxRow)
    ...
    public EnquiryDetailsPostRequirementFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_enquiry_details_post_requirement, container, false);
...
/*
                    ...
                    linearLayoutSellerDetails.setVisibility(VISIBLE);
                    tvSellerName.setText(bundle.getString("userName"));
                    UA_mobile = bundle.getString("UA_mobile");
