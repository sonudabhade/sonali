...
public class AdapterFirmList extends ArrayAdapter<FirmListModel> {
    ...
    public AdapterFirmList(@NonNull Context context, int resource, int textViewResourceId, @NonNull ArrayList<FirmListModel> objects) {
        super(context, resource, textViewResourceId, objects);
        mContext=context;
        mFirmListModelArrayList=objects;
    ...
    public int getCount() {
        super.getCount();
        return mFirmListModelArrayList.size();
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        mTextView.setText(mFirmListModelArrayList.get(position).getLegal_firm());
        return convertView;
    }
