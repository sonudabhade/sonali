...
public class AdapterSubCategoryList extends ArrayAdapter<SubCategoryModel> {
    ...
    public AdapterSubCategoryList(@NonNull Context context, int resource, int textViewResourceId, @NonNull ArrayList<SubCategoryModel> objects) {
