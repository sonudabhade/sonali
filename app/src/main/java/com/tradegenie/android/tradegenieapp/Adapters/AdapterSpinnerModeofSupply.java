...
public class AdapterSpinnerModeofSupply extends ArrayAdapter<ModeOfSupplyModel> {

    private Context mContext;
    public ArrayList<ModeOfSupplyModel> listState;
    private AdapterSpinnerModeofSupply mAdapterSpinnerModeofSupply;
    private boolean isFromView = false;
    private AddNewProduct mAddNewProduct;


    public AdapterSpinnerModeofSupply(Context context, int resource, List<ModeOfSupplyModel> objects, AddNewProduct addNewProduct) {
    ...
    public View getCustomView(final int position, View convertView,
        ...
        holder.mCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                mAddNewProduct.getModeofSupplyCount();
